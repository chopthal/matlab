function [k, kName, chi2, T, R] = OneToOneStandardFitting(concentration, eventTime, xdata, ydata, fittingVariables)
...
function F = LsqFit(k, xdata, pfuncAsso, pfuncDisso, eventTime, concentration, idxVar)

    [T, R] = ODESolve(k, xdata, pfuncAsso, pfuncDisso, eventTime, concentration, idxVar);
    F = R(:, 3);
