...
app.UIPanelFittingModel.Layout.Row = 1;
app.UIPanelFittingModel.Layout.Column = 1;
...
app.UIListBoxParameters.Items = {'koff'; 'kon'; 'Rmax'; 'BI'};
% Setting Panel
...
% Initial Value EditField
app.UIEditFieldSettingInitialValue = uieditfield(app.UIGridFittingParametersSetting, 'numeric');
app.UIEditFieldSettingInitialValue.Value = 100000;
app.UIEditFieldSettingInitialValue.Layout.Row = 2; app.UIEditFieldSettingInitialValue.Layout.Column = 2;
% Negative CheckBox
...
app.UIGridButton.RowHeight = {'1x'};
app.UIGridButton.ColumnWidth = {'1x', 120, 120, 120};
% Default Button
